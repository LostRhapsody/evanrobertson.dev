...
$("#terminal").terminal(
  {
    ...
    project: function (project) {
      if (
        ...
        this.echo(
          $(
            '<img src="./static/slothtime.jpeg" class="terminal-image"  alt:"The Slothtime web app main screen, showcasing a table of example time entries.">'
          )
        );
        this.echo(
          "Slothtime\n" +
  ...
  {
    greetings:
      "Welcome to evanrobertson.dev, an interactive personal portfolio.\n" +
      "Type 'help' to view a list of available commands\n" +
      "Don't feel like typing commands? Just type 'gallery' to view a more traditional portfolio experience.\n",
      prompt: "evanrobertson.dev> ",
      name: "evanrobertson.dev",
      height: "500",
  }
);
